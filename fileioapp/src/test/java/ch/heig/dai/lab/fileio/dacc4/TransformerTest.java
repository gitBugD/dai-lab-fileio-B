...
import ch.heig.dai.lab.fileio.dacc4.Transformer;
...
public class TransformerTest {
    ...
    private final ch.heig.dai.lab.fileio.dacc4.Transformer transformer = new Transformer(newName, numWordsPerLine);
